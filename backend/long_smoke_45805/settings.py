"""
Django settings for long_smoke_45805 project.
...
ROOT_URLCONF = 'long_smoke_45805.urls'
...
WSGI_APPLICATION = 'long_smoke_45805.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "long_smoke_45805 API",
    "DESCRIPTION": "API documentation for long_smoke_45805 App",
    "VERSION": "v1",
}
